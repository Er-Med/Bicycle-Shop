...
export default function Banner({ title, className }: BannerProps) {
 return (
  <div className={`${className} relative mb-28 h-[250px] md:h-[350px] flex justify-center items-center`}>
   <div className='absolute w-full h-full top-0 left-0 bg-[--primary] opacity-90 z-10'></div>
   <h1 className='text-4xl font-bold mx-auto text-center text-white relative z-30 '>{title}</h1>
   <Image
    src={banner}
    alt='image'
